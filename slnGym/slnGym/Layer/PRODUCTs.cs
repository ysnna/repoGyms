...
namespace slnGym.Layer
{
    class PRODUCTs
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select A.receiptID as 'ID', nameServices as 'Name', period as 'Quantity',total as 'Total', repceiptDate as 'Date payment' from DETAILSREPCEIPT," +
