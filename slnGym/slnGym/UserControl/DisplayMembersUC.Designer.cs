namespace slnGym.User_Control
{
    partial class DisplayMembersUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panelMembers.Controls.Add(this.btStatistic);
            this.panelMembers.Controls.Add(this.btReceipt);
            this.panelMembers.Controls.Add(this.btContract);
            this.panelMembers.Controls.Add(this.btMember);
            this.panelMembers.Controls.Add(this.btEmployee);
            this.panelMembers.Controls.Add(this.btLogin);
